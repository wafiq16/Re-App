...
class FaceNetService {
  ...
  setCurrentPrediction(CameraImage cameraImage, Face face, bool front) {
    /// crops the face from the image and transforms it to an array of data
    // if (!front) {
    // cameraImage = cameraImage.format();
    // }

    List input = _preProcess(cameraImage, face, front);
  ...
  /// [face]: face detected
  List _preProcess(CameraImage image, Face faceDetected, bool front) {
    // crops the face 💇
    imglib.Image croppedImage = _cropFace(image, faceDetected, front);
  ...
  /// [cameraImage]: current image
  /// [face]: face detected
  imglib.Image _cropFace(CameraImage image, Face faceDetected, bool front) {
